...
$.fn.ayoshare = function(opt) {
    ...
    $(this).each(function(i, d) {
        ...
        if (opt.button.facebook) {
			...
			if(opt.counter){
				html += '<i class="icon"><i class="fab fa-facebook"></i></i><div class="counter"><p><i class="fas fa-spinner fa-spin"></i></p></div></a></div>';
				ayo_facebook(b, c, i);
			}else{
				html += '<i class="mobile"><i class="fab fa-facebook"></i></i></a></div>';
			}
        }
        if (opt.button.reddit) {
			html += '<div class="reddit button' + (opt.counter ? '' : ' small') + '"><a onclick="ayo_share_og(\'' + b + '\', \'reddit\');" title="Reddit">';
			if(opt.counter){
				html += '<i class="icon"><i class="fab fa-reddit"></i></i><div class="counter"><p><i class="fab fa-spinner fa-spin"></i></p></div></a></div>';
				ayo_reddit(b, c, i);
			}else{
				html += '<i class="mobile"><i class="fab fa-reddit"></i></i></a></div>';
			}
        }
        if (opt.button.linkedin) {
			html += '<div class="linkedin button' + (opt.counter ? '' : ' small') + '"><a onclick="ayo_share_og(\'' + b + '\', \'linkedin\');" title="Linkedin">';
			if(opt.counter){
				html += '<i class="icon"><i class="fab fa-linkedin"></i></i><div class="counter"><p><i class="fab fa-spinner fa-spin"></i></p></div></a></div>';
				ayo_linkedin(b, c, i);
			}else{
				html += '<i class="mobile"><i class="fab fa-linkedin"></i></i></a></div>';
			}
        }
        if (opt.button.pinterest) {
			...
			if(opt.counter){
				html += '<i class="icon"><i class="fab fa-pinterest"></i></i><div class="counter"><p><i class="fab fa-spinner fa-spin"></i></p></div></a></div>';
				ayo_pinterest(b, c, i);
			}else{
				html += '<i class="mobile"><i class="fab fa-pinterest"></i></i></a></div>';
			}
        }
        if (opt.button.stumbleupon) {
			...
			if(opt.counter){
				html += '<i class="icon"><i class="fab fa-stumbleupon"></i></i><div class="counter"><p><i class="fab fa-spinner fa-spin"></i></p></div></a></div>';
				ayo_stumbleupon(b, c, i);
			}else{
				html += '<i class="mobile"><i class="fab fa-stumbleupon"></i></i></a></div>';
			}
        }
        if (opt.button.bufferapp) {
			...
			if(opt.counter){
				html += '<i class="icon"><i class="fab fa-bufferapp"></i></i><div class="counter"><p><i class="fab fa-spinner fa-spin"></i></p></div></a></div>';
				ayo_bufferapp(b, c, i);
			}else{
				html += '<i class="mobile"><i class="fab fa-bufferapp"></i></i></a></div>';
			}
        }
        if (opt.button.vk) {
			html += '<div class="vk button' + (opt.counter ? '' : ' small') + '"><a onclick="ayo_share_og(\'' + b + '\', \'vk\');" title="VK">';
			if(opt.counter){
				html += '<i class="icon"><i class="fab fa-vk"></i></i><div class="counter"><p><i class="fab fa-spinner fa-spin"></i></p></div></a></div>';
				ayo_vk(b, c, i);
			}else{
				html += '<i class="mobile"><i class="fab fa-vk"></i></i></a></div>';
			}
        }
        if (opt.button.pocket) {
			html += '<div class="pocket button' + (opt.counter ? '' : ' small') + '"><a onclick="ayo_share_og(\'' + b + '\', \'pocket\');" title="Pocket">';
			if(opt.counter){
				html += '<i class="icon"><i class="fab fa-get-pocket"></i></i><div class="counter"><p><i class="fab fa-spinner fa-spin"></i></p></div></a></div>';
				ayo_pocket(b, c, i);
			}else{
				html += '<i class="mobile"><i class="fab fa-get-pocket"></i></i></a></div>';
			}
        }
        if (opt.button.google) {
            html += '<div class="google button' + (opt.counter ? '' : ' small') + '"><a onclick="ayo_share_og(\'' + b + '\', \'google\');" title="Google+">';
            html += '<i class="mobile"><i class="fab fa-google-plus"></i></i></a></div>';
        }
